...
function sendEmail(name, email, adresse, land, message) {
    fetch('http://www.dognate.net/ajax-email.php',
        ...
        body: `name=${encodeURI(name)}&email=${encodeURI(email)}&adresse=${encodeURI(adresse)}
        &land=${encodeURI(land)}&message=${encodeURI(message)}`
    })
}
//Kasse
function purchaseClicked() {
    ...
    sendEmail(name, email, adresse, land, cartItems, 'test nachricht')
