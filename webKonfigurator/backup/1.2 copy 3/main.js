    ...
    const scene = new BABYLON.Scene(engine);
        ...
        //Load models
        BABYLON.SceneLoader.ImportMeshAsync("", "./", "assets/models/threeSphere.babylon")
            .then(function (result) {

                //Zoom to adjust
                scene.activeCamera.lowerRadiusLimit = 0;
                scene.activeCamera.upperRadiusLimit = 40;
                scene.activeCamera.useBouncingBehavior = true;

                //Texture to material
                gold = new BABYLON.StandardMaterial("Gold", scene);
                gold.diffuseTexture = new BABYLON.Texture("assets/images/okt.jpg", scene);

                silber = new BABYLON.StandardMaterial("Silber", scene);
                silber.diffuseTexture = new BABYLON.Texture("assets/images/rinde.jpg", scene);

                bronze = new BABYLON.StandardMaterial("Bronze", scene);
                bronze.diffuseTexture = new BABYLON.Texture("assets/images/dirndel.jpg", scene);

                rosegold = new BABYLON.StandardMaterial("Rosegold", scene);
                rosegold.diffuseTexture = new BABYLON.Texture("assets/images/candy_1.jpg", scene);
